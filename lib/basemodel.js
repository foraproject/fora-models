(function() {
	...
	BaseModel.create = function*(params, typesService) {
		var actualTypeDef, obj, typeDef;
		typeDef = yield* this.getTypeDefinition(typesService);
		if (typeDef.discriminator) {
			actualTypeDef = yield* typeDef.discriminator(params, typesService);
