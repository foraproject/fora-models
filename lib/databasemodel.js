...
(function() {
	...
	DatabaseModel = (function(_super) {
		...
		DatabaseModel.constructModelFields = function*(obj, typeDefinition, context, db) {
			var arr, def, fieldName, item, name, result, typesService, value, _i, _len, _ref, _ref1;
			result = {};
			typesService = this.getTypesService();
		...
		DatabaseModel.prototype.link = function*(name, context, db) {
			var k, link, otherTypeDef, params, query, result, typeDef, typesService, v, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4;
			_ref = this.getContext(context, db);
			context = _ref.context;
			db = _ref.db;
			typesService = this.constructor.getTypesService();
